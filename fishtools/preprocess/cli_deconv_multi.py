# fishtools/preprocess/deconv/cli_deconv_multi.py
...
if __name__ == "__main__":  # pragma: no cover
    # Enable running the module directly as a script:
    #   python fishtools/preprocess/cli_deconv_multi.py prepare /path R1 R2
    # or other subcommands under the multi_deconv group.
    multi_deconv()
